...
@Component({
    selector: 'app-pre-approved-credit-consumer-automotive',
    templateUrl: './pre-approved-credit-consumer-automotive.component.html',
    styleUrls: ['./pre-approved-credit-consumer-automotive.component.scss']
})
export class PreApprovedCreditConsumerAutomotiveComponent implements OnInit {
    ...
    sentCode() {
        ...
        this._preArpovedCreditService.validateCredit({'codigo': code, 'cedula': document})
            .subscribe((data: any) => {
                ...
                localStorage.setItem('simulador', 'credito-automotriz');
                localStorage.setItem('credito', JSON.stringify(data));
                this._router.navigate([
                    `/pages/preApprovedEndConsumerAutomotive`], {queryParams: data}
                );
            }, (error: any) => {
    ...
    actionContinue() {
        this._router.navigate([
            `/pages/preApprovedEndConsumerAutomotive`,
        ]);
    }
}
