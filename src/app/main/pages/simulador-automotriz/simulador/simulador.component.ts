...
export class SimuladorComponent implements OnInit {
    ...
    listCombosbox() {
        ...
        this.paramService.obtenerListaPadresSinToken('CREDITO_AUTOMOTRIZ_VALORES_CALCULAR_CREDITO_CREDICOMPRA').subscribe((info) => {
            info.map(item => {
    ...
    calcular() {
        ...
        this._router.navigate(['/pages/credito-automotriz/requisitos']);
    }
