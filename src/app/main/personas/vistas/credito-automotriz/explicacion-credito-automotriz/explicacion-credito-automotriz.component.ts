...
@Component({
    ...
    template: `
        <div class="content-wrapper bg-white">
            <div class="card-body text-center">
                <img src="/assets/images/logo/logos-png.png" alt="brand-logo" width="300"/>
            </div>
    ...
    `,
    styleUrls: ['./explicacion-credito-automotriz.component.scss']
})
export class ExplicacionCreditoAutomotrizComponent implements OnInit, OnDestroy {
